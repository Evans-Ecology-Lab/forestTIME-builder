...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [28.4s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [42.7s]
```
...
#> ℹ Interpolating between surveys
#> ℹ Expanding years between surveys
#> ✔ Expanding years between surveys [7.3s]
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [27.9s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [42s]
```
...
#> ℹ Expanding years between surveys
#> ✔ Expanding years between surveys [7.2s]
#> 
data_expanded
```
...
#> ✔ Prepping for estimating carbon [206ms]
#> 
...
#> ✔ Estimating carbon: harmonizing components [29.5s]
#> 
data_midpt_carbon
```
