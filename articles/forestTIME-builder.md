...
#> ✔ Expanding years between surveys [7.6s]
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [28.8s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [43.1s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [28.9s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [43.4s]
```
...
#> ℹ Expanding years between surveys
#> ✔ Expanding years between surveys [7.5s]
#> 
data_expanded
```
...
#> ✔ Prepping for estimating carbon [406ms]
#> 
