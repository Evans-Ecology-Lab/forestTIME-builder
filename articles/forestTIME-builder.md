...
#> ✔ Expanding years between surveys [8.5s]
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [29.9s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [44.7s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [29.1s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [43.9s]
```
...
#> ✔ Prepping for estimating carbon [241ms]
#> 
...
#> ✔ Estimating carbon: harmonizing components [29.9s]
#> 
data_midpt_carbon
```
