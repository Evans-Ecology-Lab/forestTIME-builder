...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [41.8s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 3.1s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [40.7s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 1.8s]
```
...
#> ℹ Interpolating between surveys
#> ✔ Interpolating between surveys [33.4s]
#> 
data_interpolated
```
...
#> ✔ Prepping for estimating carbon [229ms]
#> 
