...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [41.5s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 5.5s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [41.6s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 5.8s]
```
...
#> ℹ Interpolating between surveys
#> ✔ Interpolating between surveys [33.1s]
#> 
data_interpolated
```
...
#> ✔ Prepping for estimating carbon [230ms]
#> 
...
#> ✔ Estimating carbon: harmonizing components [31.5s]
#> 
data_midpt_carbon
```
