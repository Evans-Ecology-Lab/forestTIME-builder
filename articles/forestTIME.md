...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [25.4s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [29.7s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [25.3s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [29.8s]
```
...
#> ℹ Expanding years between surveys
#> ✔ Expanding years between surveys [8.3s]
#> 
data_expanded
```
...
#> ℹ Interpolating between surveys
#> ✔ Interpolating between surveys [16.5s]
#> 
data_interpolated
```
...
#> ✔ Prepping for estimating carbon [496ms]
#> 
...
#> ✔ Estimating carbon: harmonizing components [31.6s]
#> 
#> ℹ Joining carbon estimation results
#> ✔ Joining carbon estimation results [34ms]
#> 
data_midpt_carbon
```
