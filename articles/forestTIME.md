...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [35.3s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [55.1s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [35s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [55s]
```
...
#> ℹ Interpolating between surveys
#> ✔ Interpolating between surveys [27s]
#> 
data_interpolated
```
...
#> ✔ Prepping for estimating carbon [439ms]
#> 
...
#> ✔ Estimating carbon: harmonizing components [30.4s]
#> 
data_midpt_carbon
```
