...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [40.8s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 1.9s]
```
...
#> 
#> ℹ Interpolating between surveys
✔ Interpolating between surveys [40.5s]
#> 
#> ℹ Adjusting for mortality
✔ Adjusting for mortality [1m 1.5s]
```
...
#> ℹ Interpolating between surveys
#> ✔ Interpolating between surveys [32.6s]
#> 
data_interpolated
```
...
#> ✔ Prepping for estimating carbon [226ms]
#> 
