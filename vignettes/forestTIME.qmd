...
`fia_allometry()` uses code provided by David Walker to calculate carbon and biomass variables using the National Scale Volume and Biomass estimators (NSVB) [@westfall2024].
